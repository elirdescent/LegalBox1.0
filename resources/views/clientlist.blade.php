...
<div class="modal">
  <div class="modal-box">
    <h1 class="flex justify-start   text-3xl font-extrabold text-gray-900 text-white md:text-3xl lg:text-3xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{{$cli->name}} {{$cli->surname}}</span></h1>
    <div class="flex">
      ...
      <h1 class="flex justify-start   text-md font-bold text-gray-900 text-white md:text-md lg:text-md"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{{$cli->username}}</span></h1>
    </div>
