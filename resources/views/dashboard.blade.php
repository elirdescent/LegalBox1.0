          ...
          <div class="z-10 fixed flex h-screen flex-shrink-0 transition-all">
            ...
            >
              ...
              <button
                ...
                :class="(isSidebarOpen && currentSidebarTab == 'linksTab') ? 'text-white bg-blue-600' : 'text-gray-500 bg-white'"
              >
                ...
                <div class="reviews  mb-20 ml-10 mr-10">
                  ...
                  <section class="text-neutral-700 text-neutral-300">
                      ...
                      <div class="grid lg:ml-10 gap-6 text-center md:grid-cols-3">
                        <div>
                          <div
                            class="block rounded-lg  shadow-lg bg-neutral-700 shadow-black/30">
                            <div class=" overflow-hidden rounded-t-lg bg-neutral-700">
                              <h4 class="mb-4 mt-5 text-2xl font-semibold">Car Theft</h4>
                                         <div class="p-none m-none h-30 radial-progress bg-blue-200 text-teal-700 border-4 border-blue-200" style="--value:70;">70%</div>
                            ...
                            <div class="p-6">
                              ...
                              <p class="mt-4">
                                ...
                                Car theft felony, possible release on bond or house arrest.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <!-- Case-->
                        <div>
                          <div
                            class="block rounded-lg  shadow-lg bg-neutral-700 shadow-black/30">
                            <div class=" overflow-hidden rounded-t-lg bg-neutral-700">
                              <h4 class="mb-4 mt-5 text-2xl font-semibold">RICO Indictment</h4>
                            ...
                            <div class="p-6">
                              ...
                              <p class="mt-4">
                                ...
                                RICO Indictment, possible 25 to life sentence.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          <div
                            class="block rounded-lg  shadow-lg bg-neutral-700 shadow-black/30">
                            <div class=" overflow-hidden rounded-t-lg bg-neutral-700">
                              <h4 class="mb-4 mt-5 text-2xl font-semibold">Domestic Violence</h4>
                            ...
                            <div class="p-6">
                              <h4 class="mb-4 text-2xl font-semibold">Peter Baker</h4>
                              <hr />
                              <p class="mt-4">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                ...
                                Domestic violence case, possible false accusation for lack of evidence.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          <div
                            class="block rounded-lg  shadow-lg bg-neutral-700 shadow-black/30">
                            <div class=" overflow-hidden rounded-t-lg bg-neutral-700">
                              <h4 class="mb-4 mt-5 text-2xl font-semibold">Hit and Run</h4>
                            ...
                            <div class="p-6">
                              <h4 class="mb-4 text-2xl font-semibold">Alice Scott</h4>
                              <hr />
                              <p class="mt-4">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                ...
                                Hit and run with two injured, possible house arrest.
                              </p>
                            </div>
                          </div>
                        </div>
